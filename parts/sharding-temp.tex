...
% \emph{opening} all posting list shards for each query term, and
...
\begin{figure}[tb]
	\centering
		%\includegraphics[width=0.6\textwidth]{resources/qp_relaxed.pdf}
		\includegraphics[width=0.6\textwidth]{resources/shard_merging.pdf}
...
\begin{figure*}[!htb]
  ...
  10]{\label{fig:wiki_index_merge_10.0}\includegraphics[width=0.4\textwidth]{plots/updates/pdfs/index_maintenance_wiki_10.pdf}}
  %\quad
  \subfigure[$\eta$ =
  100]{\label{fig:wiki_index_merge_100.0}\includegraphics[width=0.4\textwidth]{plots/updates/pdfs/index_maintenance_wiki_100.pdf}}
  \quad
  \subfigure[$\eta$ =
  1000]{\label{fig:wiki_index_merge_1000.0}\includegraphics[width=0.4\textwidth]{plots/updates/pdfs/index_maintenance_wiki_1000.pdf}}
...
\begin{figure*}[!htb]
  \centering \subfigure[$\eta$ =
  10]{\label{fig:ukgov_index_merge_10.0}\includegraphics[width=0.4\textwidth]{plots/updates/pdfs/index_maintenance_ukgov_10.pdf}}
  %\quad
  \subfigure[$\eta$ =
  100]{\label{fig:ukgov_index_merge_100.0}\includegraphics[width=0.4\textwidth]{plots/updates/pdfs/index_maintenance_ukgov_100.pdf}}
  \quad
  \subfigure[$\eta$ =
  1000]{\label{fig:ukgov_index_merge_1000.0}\includegraphics[width=0.4\textwidth]{plots/updates/pdfs/index_maintenance_ukgov_1000.pdf}}
