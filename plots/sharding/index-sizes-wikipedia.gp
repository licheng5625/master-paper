...
set grid
set output '| ps2pdf - ./index-sizes-wikipedia.pdf
...
plot "index-sizes-wikipedia.dat" index 0 using 2:xtic(1) title "Non-Coalesced" fs solid 0.75 lt -1,\
     "index-sizes-wikipedia.dat" index 0 using 3:xtic(1) title "Coalesced" fs pattern 6 lt -1
